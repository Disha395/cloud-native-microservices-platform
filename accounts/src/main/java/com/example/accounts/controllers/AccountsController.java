...
@Tag(
        ...
        description = "CRUD REST APIs in order to CREATE, UPDATE, FETCH AND DELETE account details"
)
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get Contact Info that can be reached out to in case of anny issue"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
